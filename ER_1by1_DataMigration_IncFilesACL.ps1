...
function LoopSubFoldersAndFiles($RootPath){
    ...
    foreach ($Folder in $Folders) {
        ...
        ForEach ($Access in $Acl.Access) {
            ...
            $Properties = "FOLDER;""" + $Folder.FullName + """;;" + $Folder.CreationTime + ";" + $Folder.LastAccessTime + ";" + $Folder.LastWriteTime  + ";" + $FolderSizeGB + ";" + $FolderSizeMB +";" + $FolderSizeKB + ";" + $FolderFileCount + ";;" + $FolderOwner + ";;" + $Access.IdentityReference + ";" + $Access.FileSystemRights + ";" + $Access.IsInherited
        ...
        if($Folder -ne $null) {
            ...
            $FolderFileCount = $FSOFolder.Files.Count 
            $OutInfo = "FOLDER;""" + $CleanFolderName + """;;" + $Folder.CreationTime + ";" + $Folder.LastAccessTime + ";" + $Folder.LastWriteTime  + ";" + $FolderSizeGB + ";" + $FolderSizeMB +";" + $FolderSizeKB + ";" + $FolderFileCount + ";;" + $FolderOwner + ";;" + $Access.IdentityReference + ";" + $Access.FileSystemRights + ";" + $Access.IsInherited
            ...
            if($FolderFileCount -gt 0){
                ...
                if($Files -ne $null) {
                    ...
                    Foreach ($File in $Files) {
						...
						$OutInfo = "FILE;""" + $CleanFolderName + """;""" + $File.Name  + """;" + $File.CreationTime + ";" + $File.LastAccessTime + ";" + $File.LastWriteTime + ";" + $FolderSizeGB + ";" + $FolderSizeMB + ";" + $FolderSizeKB + ";" + "N/A" + ";" + $File.Extension + ";" + $FileOwner + ";" + $File.IsReadOnly + ";" + $File_Access.IdentityReference + ";" + $File_Access.FileSystemRights + ";" + $File_Access.IsInherited
